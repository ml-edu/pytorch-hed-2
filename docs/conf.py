...
htmlhelp_basename = 'pytorch-hed_doc'
...
latex_documents = [
    (master_doc, 'pytorch-hed.tex', 'pytorch-hed Documentation',
     'Davide Lanza', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytorch-hed', 'pytorch-hed Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytorch-hed', 'pytorch-hed Documentation',
     author, 'pytorch-hed', 'One line description of project.',
     'Miscellaneous'),
]
